...
def _compute_scale_kernel(
    ...
    tl.atomic_max(scale_ptr, local_max / FP8_MAX)


def compute_fp8_scale(x: torch.Tensor, scale_out: torch.Tensor) -> None:
    """Compute max_abs(x) / FP8_E4M3_MAX and write to scale_out (scalar tensor).
    ...
    _compute_scale_kernel[grid](x, scale_out, n, BLOCK_SIZE=BLOCK, FP8_MAX=FP8_E4M3_MAX)
